...
function Signin(){
  ...
  <div className="mb-3">
  <pre></pre><pre></pre>
   <h3 className='signin'>Sign In To Account</h3><pre></pre>
  ...
  <div className="mb-3">
    ...
    <input type="password" className="form-control fonticons" id="exampleInputPassword1" placeholder="&#xf084; Password "  required />
  </div>
  <div className='text-center'><Link to='/dashboard' className='submitbutton' >Login</Link></div>
  <div className='text-center pt-1'>
  <Link to='/Forgetpassword' className='downtext'>Forget Password</Link>
  <p className='downtext'> </p>
  </div>
